...
var pngLib = require('@pdf-lib/upng');
var fontkit = require('@pdf-lib/fontkit');

exports.RegistryTypes = void 0;
...
})(exports.RegistryTypes || (exports.RegistryTypes = {}));
class Registry {
    static get(key) {
...
class PdfBuffer {
    get length() {
        return this.raw.length + tslib.__classPrivateFieldGet(this, _PdfBuffer_streamLength, "f");
    }
    ...
    begin() {
        tslib.__classPrivateFieldSet(this, _PdfBuffer_stream, true, "f");
        return this;
    }
    end(endLine) {
        tslib.__classPrivateFieldSet(this, _PdfBuffer_stream, false, "f");
        tslib.__classPrivateFieldSet(this, _PdfBuffer_streamLength, 0, "f");
        if (!tslib.__classPrivateFieldGet(this, _PdfBuffer_lines, "f").length) {
            return this;
        }
        if (endLine) {
            this.append(tslib.__classPrivateFieldGet(this, _PdfBuffer_lines, "f"), endLine);
        }
        else {
            this.append(tslib.__classPrivateFieldGet(this, _PdfBuffer_lines, "f"));
        }
        tslib.__classPrivateFieldSet(this, _PdfBuffer_lines, [], "f");
        return this;
    }
    append(raw, endLine) {
        const objs = [];
        ...
        if (tslib.__classPrivateFieldGet(this, _PdfBuffer_stream, "f")) {
            for (let index = 0; index < objs.length; index++) {
                const obj = objs[index];
                tslib.__classPrivateFieldSet(this, _PdfBuffer_streamLength, tslib.__classPrivateFieldGet(this, _PdfBuffer_streamLength, "f") + obj.length, "f");
                tslib.__classPrivateFieldGet(this, _PdfBuffer_lines, "f").push(obj);
                if (index !== objs.length - 1 && endLine) {
                    tslib.__classPrivateFieldSet(this, _PdfBuffer_streamLength, tslib.__classPrivateFieldGet(this, _PdfBuffer_streamLength, "f") + endLine.length, "f");
                    tslib.__classPrivateFieldGet(this, _PdfBuffer_lines, "f").push(endLine);
                }
            }
            return this;
        }
    ...
    subarray(begin = 0, end) {
        const view = Registry.get(exports.RegistryTypes.PdfView);
...
class PdfObject extends RawData {
    ...
    get xref() {
        if (!tslib.__classPrivateFieldGet(this, _PdfObject_xref, "f")) {
            throw new Error("XRef пустой");
        }
        return tslib.__classPrivateFieldGet(this, _PdfObject_xref, "f");
    }
    set xref(v) {
        tslib.__classPrivateFieldSet(this, _PdfObject_xref, v, "f");
    }
    ref(type) {
        if (!this.parent) {
    ...
    change() {
        ...
        while (parent && !(parent instanceof Registry.get(exports.RegistryTypes.PdfIndirectObject))) {
    ...
    reWriteRaw(v) {
        ...
        const WriterClass = Registry.get(exports.RegistryTypes.Writer);
...
class PdfComment extends PdfObject {
    ...
    get value() {
        return tslib.__classPrivateFieldGet(this, _PdfComment_value, "f");
    }
    set value(v) {
        if (v !== this.value) {
            this.change();
            tslib.__classPrivateFieldSet(this, _PdfComment_value, v, "f");
        }
    }
}
...
class PdfBoolean extends PdfObject {
    constructor(param = {}) {
        ...
        tslib.__classPrivateFieldSet(this, _PdfBoolean_value, (_a = param.value) !== null && _a !== void 0 ? _a : false, "f");
    }
    get value() {
        return tslib.__classPrivateFieldGet(this, _PdfBoolean_value, "f");
    }
    set value(v) {
        if (v !== tslib.__classPrivateFieldGet(this, _PdfBoolean_value, "f")) {
            this.change();
            tslib.__classPrivateFieldSet(this, _PdfBoolean_value, v, "f");
        }
    }
}
...
class PdfName extends PdfObject {
    constructor(param = {}) {
        ...
        tslib.__classPrivateFieldSet(this, _PdfName_value, (_a = param.value) !== null && _a !== void 0 ? _a : "", "f");
    }
    get value() {
        return tslib.__classPrivateFieldGet(this, _PdfName_value, "f");
    }
    set value(v) {
        if (v !== tslib.__classPrivateFieldGet(this, _PdfName_value, "f")) {
            this.change();
            tslib.__classPrivateFieldSet(this, _PdfName_value, v, "f");
        }
    }
}
...
class PdfNumber extends PdfObject {
    constructor(param = {}) {
        ...
        tslib.__classPrivateFieldSet(this, _PdfNumber_value, (_a = param.value) !== null && _a !== void 0 ? _a : 0, "f");
    }
    get value() {
        return tslib.__classPrivateFieldGet(this, _PdfNumber_value, "f");
    }
    set value(v) {
        if (v !== tslib.__classPrivateFieldGet(this, _PdfNumber_value, "f")) {
            this.change();
            tslib.__classPrivateFieldSet(this, _PdfNumber_value, v, "f");
        }
    }
    onConvert(obj) {
    ...
    onSetValue(v) {
        tslib.__classPrivateFieldSet(this, _PdfNumber_value, tslib.__classPrivateFieldGet(v, _PdfNumber_value, "f"), "f");
    }
    reWriteValue(v) {
...
class PdfString extends PdfObject {
    constructor(param = {}) {
        ...
        tslib.__classPrivateFieldSet(this, _PdfString_value, (_a = param.value) !== null && _a !== void 0 ? _a : "", "f");
    }
    get value() {
        return tslib.__classPrivateFieldGet(this, _PdfString_value, "f");
    }
    set value(v) {
        if (v !== tslib.__classPrivateFieldGet(this, _PdfString_value, "f")) {
            this.change();
            tslib.__classPrivateFieldSet(this, _PdfString_value, v, "f");
        }
    }
    onSetValue(v) {
        tslib.__classPrivateFieldSet(this, _PdfString_value, tslib.__classPrivateFieldGet(v, _PdfString_value, "f"), "f");
    }
    toBinary() {
...
class Predictor {
    static decode(data, params) {
        ...
        const bits = ((_c = params.find("BPC", PdfNumber)) === null || _c === void 0 ? void 0 : _c.value) || ((_d = params.find(exports.Names.BitsPerComponent, PdfNumber)) === null || _d === void 0 ? void 0 : _d.value) || 8;
...
class FlateDecode {
    constructor() {
        this.name = exports.Names.FlateDecode;
    }
...
class ASCII85Decode {
    constructor() {
        this.name = exports.Names.ASCII85Decode;
    }
    encode(data) {
...
class ASCIIHexDecode {
    constructor() {
        this.name = exports.Names.ASCIIHexDecode;
    }
    encode(data) {
        let result = "";
        for (let i = 0; i < data.length; i++) {
...
function decodeString(str, encoding) {
    let decodedStr = "";
    if (encoding !== exports.Encoding.Binary) {
...
class StringConverter {
    static readHex(raw) {
        ...
        if (hasUtf16BeBOM(hexStrAsArr)) {
            encoding = exports.Encoding.Utf16Be;
        }
        else if (hasUtf8BOM(hexStrAsArr)) {
            encoding = exports.Encoding.Utf8;
        }
        else {
            encoding = exports.Encoding.Binary;
        }
    ...
    static readLiteral(raw) {
        ...
        if (hasUtf8BOM(unescapedRaw)) {
            decodedStr = decodeString(unescapedRaw, exports.Encoding.Utf8);
        }
        else if (hasUtf16BeBOM(unescapedRaw)) {
            decodedStr = decodeString(unescapedRaw, exports.Encoding.Utf16Be);
        }
        else {
            decodedStr = decodeString(unescapedRaw, exports.Encoding.Binary);
        }
        return decodedStr;
    }
...
class JpegInfo {
    static getInfo(jpeg) {
        ...
        offset += 2;
        const colorSpace = exports.ColorNames[view.getUint8(offset++)];
        if (!colorSpace) {
            throw new Error("Неизвестный ColorSpace.");
        }
        return {
            type: exports.ImageTypes.JPEG,
            buf: jpeg,
            info: {
                bitsPerComponent,
                width,
...
class PngInfo {
    static getInfo(image) {
        const upng = pngLib.default.decode(image);
        const frames = pngLib.default.toRGBA8(upng);
        if (frames.length > 1) {
...
})(exports.ColorNames || (exports.ColorNames = {}));
...
class PdfFontFlags extends PdfFlags {
    constructor(options) {
        super(exports.FontFlags, options);
    }
}
exports.FontFlags = void 0;
(function (FontFlags) {
...
})(exports.FontFlags || (exports.FontFlags = {}));
...
class CustomFont {
    ...
    get subtype() {
        return this.font.cff ? exports.Names.CIDFontType0 : exports.Names.CIDFontType2;
    }
    get cidToGIDMap() { return exports.Names.Identity; }
    get widths() {
...
class PdfDictionary extends PdfObject {
    ...
    get id() {
        ...
        if (this.parent instanceof PdfDictionary
            ...
            || this.parent instanceof Registry.get(exports.RegistryTypes.PdfArray)) {
    ...
    find(key, type) {
        ...
        if (res instanceof Registry.get(exports.RegistryTypes.PdfIndirectObject)) {
            res = res.value;
        }
        if (!res) {
            return null;
    ...
    set(key, obj) {
        ...
        if (!(obj instanceof Registry.get(exports.RegistryTypes.PdfIndirectObject)) && !obj.parent) {
            obj.parent = this;
        }
        obj.xref = this.xref;
    }
    findOrSet(key, type, ref) {
        ...
        if (!field) {
            switch (true) {
                case type === Registry.get(exports.RegistryTypes.PdfArray):
    ...
    findInherited(key, type) {
        ...
        if (!res) {
            const parent = this.find(exports.Names.Parent, PdfDictionary);
            if (!parent) {
                return null;
            }
...
class PdfArray extends PdfObject {
    ...
    get id() {
        ...
        if (this.parent instanceof Registry.get(exports.RegistryTypes.PdfDictionary)
            || this.parent instanceof PdfIndirectObject
    ...
    push(...obj) {
        this.change();
        for (const o of obj) {
            if (!(o instanceof Registry.get(exports.RegistryTypes.PdfIndirectObject)) && !o.parent) {
                o.parent = this;
            }
        }
        this.value.push(...obj);
...
class FilterList {
    ...
    setNewFilters(...filters) {
        ...
        if (filters.length === 1) {
            ...
            this.pdfStream.set(exports.Names.Filter, this.pdfStream.doc.createName(name));
            if (params) {
                this.pdfStream.set(exports.Names.DecodeParms, params);
            }
            return;
        }
        ...
        this.pdfStream.set(exports.Names.Filter, names);
        if (writeDecodeParms) {
            this.pdfStream.set(exports.Names.DecodeParms, decodeParms);
        }
    }
    findFilters() {
        const objFilters = this.pdfStream.find(exports.Names.Filter);
        if (!objFilters) {
            return [];
        }
        const names = [];
    ...
    findDecodeParms() {
        const decodeParms = [];
        const dp = this.pdfStream.find(exports.Names.DecodeParms);
        if (dp) {
...
class PdfStream extends PdfDictionary {
    ...
    get Length() {
        return this.get(exports.Names.Length, PdfNumber).value;
    }
    set Length(value) {
        const length = this.find(exports.Names.Length, PdfNumber);
        if (!length) {
            this.set(exports.Names.Length, this.doc.createNumber(value));
        }
        else {
            length.value = value;
        }
    ...
    set rawValue(raw) {
        tslib.__classPrivateFieldSet(this, _PdfStream_rawValue, raw, "f");
        tslib.__classPrivateFieldSet(this, _PdfStream_value, undefined, "f");
        this.Length = tslib.__classPrivateFieldGet(this, _PdfStream_rawValue, "f").byteLength;
    }
    get rawValue() {
        let rawValue = tslib.__classPrivateFieldGet(this, _PdfStream_rawValue, "f");
        if (rawValue && rawValue.length) {
            return rawValue;
        }
        const value = tslib.__classPrivateFieldGet(this, _PdfStream_value, "f");
    ...
    get value() {
        let value = tslib.__classPrivateFieldGet(this, _PdfStream_value, "f");
        if (value) {
            return value;
        }
        ...
        tslib.__classPrivateFieldSet(this, _PdfStream_value, value, "f");
        return value;
    }
    set value(v) {
        let value = tslib.__classPrivateFieldGet(this, _PdfStream_value, "f");
        ...
        value = v;
        tslib.__classPrivateFieldSet(this, _PdfStream_rawValue, undefined, "f");
        this.Length = -1;
        tslib.__classPrivateFieldSet(this, _PdfStream_value, value, "f");
        this.change();
    }
    onCreate() {
        tslib.__classPrivateFieldSet(this, _PdfStream_value, new Uint8Array(), "f");
        this.Length = 0;
    }
    onConvert(obj) {
...
class PdfIndirectObject extends PdfObject {
    constructor(param) {
        ...
        this.type = (_b = param.type) !== null && _b !== void 0 ? _b : exports.IndirectObjectType.inUse;
    ...
    getValue(xref) {
        const ParserClass = Registry.get(exports.RegistryTypes.Parser);
        if (this.id === 0) {
            return new PdfNull();
        }
        let privateValue;
        switch (this.type) {
            case exports.IndirectObjectType.free:
                privateValue = new PdfNull();
                break;
            case exports.IndirectObjectType.inUse: {
                if (xref) {
            ...
            case exports.IndirectObjectType.compressed: {
                const objIo = this.xref.getIndirectObject(this.objStream);
                if (!(objIo.value instanceof PdfStream)) {
                    throw new Error("objStream");
                }
                const objStream = objIo.value.convert(Registry.get(exports.RegistryTypes.ObjectStream));
    ...
    onChange() {
        if (this.type === exports.IndirectObjectType.free) {
...
class PdfAnnotFlags extends PdfFlags {
    constructor(options) {
        super(exports.AnnotFlags, options);
    }
}
exports.AnnotFlags = void 0;
(function (AnnotFlags) {
...
})(exports.AnnotFlags || (exports.AnnotFlags = {}));
exports.AnnotFlagsName = void 0;
...
})(exports.AnnotFlagsName || (exports.AnnotFlagsName = {}));
...
exports.XRefType = void 0;
(function (XRefType) {
    XRefType[XRefType["XRefTable"] = 0] = "XRefTable";
    XRefType[XRefType["XRefStream"] = 1] = "XRefStream";
})(exports.XRefType || (exports.XRefType = {}));

class Pages extends PdfDictionary {
    get kids() {
        return this.get(exports.Names.Kids, PdfArray);
    }
    set kids(value) {
        this.set(exports.Names.Kids, value);
    }
    get count() {
        return this.get(exports.Names.Count, PdfNumber).value;
    }
    set count(value) {
        this.get(exports.Names.Count, PdfNumber).value = value;
    }
    onCreate() {
        this.set(exports.Names.Type, this.doc.createName(exports.Names.Pages));
        this.set(exports.Names.Kids, this.doc.createArray());
        this.set(exports.Names.Count, this.doc.createNumber(0));
    }
}

class Catalog extends PdfDictionary {
    get pages() {
        return this.get(exports.Names.Pages, Pages);
    }
    set pages(value) {
        this.set(exports.Names.Pages, value);
    }
    onCreate() {
        this.set(exports.Names.Type, this.doc.createName(exports.Names.Catalog));
        this.set(exports.Names.Pages, Pages.create(this.xref).ref());
    }
}

class Trailer extends PdfDictionary {
    get Size() {
        return this.get(exports.Names.Size, PdfNumber).value;
    }
    set Size(value) {
        this.get(exports.Names.Size, PdfNumber).value = value;
    }
    get Prev() {
        var _a, _b;
        return (_b = (_a = this.find(exports.Names.Prev, PdfNumber)) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : null;
    }
    set Prev(value) {
        if (value) {
            this.set(exports.Names.Prev, new PdfNumber({ value }));
        }
    }
    get Root() {
        return this.get(exports.Names.Root, Catalog);
    }
    set Root(value) {
        this.set(exports.Names.Root, value);
    }
    get ID() {
        return this.find(exports.Names.ID, PdfArray);
    }
    set ID(value) {
        if (value) {
            this.set(exports.Names.ID, value);
        }
    }
    get Info() {
        return this.find(exports.Names.Info, PdfDictionary);
    }
    set Info(value) {
        if (value) {
            this.set(exports.Names.Info, value);
        }
    }
    get Encrypt() {
        return this.find(exports.Names.Encrypt, PdfDictionary);
    }
    set Encrypt(value) {
        if (value) {
            this.set(exports.Names.Encrypt, value);
        }
    }
    onCreate() {
        this.set(exports.Names.Size, this.doc.createNumber(1));
    }
}
...
class XRefTable {
    ...
    get trailer() {
        if (tslib.__classPrivateFieldGet(this, _XRefTable_trailer, "f")) {
            return tslib.__classPrivateFieldGet(this, _XRefTable_trailer, "f");
        }
        throw new Error("XRefTable не содержит trailer");
    }
    set trailer(v) {
        tslib.__classPrivateFieldSet(this, _XRefTable_trailer, v, "f");
    }
    get doc() {
        if (tslib.__classPrivateFieldGet(this, _XRefTable_doc, "f")) {
            return tslib.__classPrivateFieldGet(this, _XRefTable_doc, "f");
        }
        throw new Error("XRefTable не содержит document");
    }
    set doc(v) {
        tslib.__classPrivateFieldSet(this, _XRefTable_doc, v, "f");
    }
    isEmptyRaw() {
        throw new Error("Метод не реализован.");
    }
...
class XRefStream extends PdfStream {
    ...
    get W() {
        return this.get(exports.Names.W, PdfArray);
    }
    set W(v) {
        this.set(exports.Names.W, v);
    }
    get Index() {
    ...
    get trailer() {
        if (!tslib.__classPrivateFieldGet(this, _XRefStream_trailer, "f")) {
            const tr = new Trailer();
            tr.xref = this;
            tr.raw = this.raw;
            tr.parent = this.parent;
            tr.values = this.values;
            if (!this.find(exports.Names.Size)) {
                tr.set(exports.Names.Size, this.doc.createNumber(1));
            }
            tslib.__classPrivateFieldSet(this, _XRefStream_trailer, tr, "f");
        }
        return tslib.__classPrivateFieldGet(this, _XRefStream_trailer, "f");
    }
    set trailer(v) {
        tslib.__classPrivateFieldSet(this, _XRefStream_trailer, v, "f");
    }
    get doc() {
        if (tslib.__classPrivateFieldGet(this, _XRefStream_doc, "f")) {
            return tslib.__classPrivateFieldGet(this, _XRefStream_doc, "f");
        }
        throw new Error("XRefTable не содержит document");
    }
    set doc(v) {
        tslib.__classPrivateFieldSet(this, _XRefStream_doc, v, "f");
    }
    push(...object) {
        for (const obj of object) {
            obj.xref = this;
    ...
    static createByParams(params) {
        ...
        xref.xref = xref;
        xref.set(exports.Names.Type, xref.doc.createName(exports.Names.XRef));
        return xref;
    }
}
...
class ObjectStream extends PdfStream {
    ...
    get N() {
        if (!this.n) {
            this.n = this.get(exports.Names.N, PdfNumber).value;
        }
        return this.n;
    }
    set N(v) {
        if (!this.n || this.n !== v) {
            this.n = this.get(exports.Names.N, PdfNumber).value = v;
        }
    }
    get First() {
        if (!this.first) {
            this.first = this.get(exports.Names.First, PdfNumber).value;
        }
        return this.first;
    }
    set First(v) {
        if (!this.first || this.first !== v) {
            this.first = this.get(exports.Names.First, PdfNumber).value = v;
        }
    }
    get Extends() {
        return this.extends;
    ...
    onCreate() {
        this.set(exports.Names.Type, this.doc.createName(exports.Names.ObjStm));
        this.set(exports.Names.N, this.doc.createNumber(0));
        this.set(exports.Names.First, this.doc.createNumber(0));
    }
}

class Image extends PdfStream {
    get width() {
        return this.get(exports.Names.Width, PdfNumber).value;
    }
    set width(value) {
        this.get(exports.Names.Width, PdfNumber).value = value;
    }
    get height() {
        return this.get(exports.Names.Height, PdfNumber).value;
    }
    set height(value) {
        this.get(exports.Names.Height, PdfNumber).value = value;
    }
    onCreate() {
        this.set(exports.Names.Type, this.doc.createName(exports.Names.XObject));
        this.set(exports.Names.Subtype, this.doc.createName(exports.Names.Image));
        this.set(exports.Names.Width, this.doc.createNumber(0));
        this.set(exports.Names.Height, this.doc.createNumber(0));
    }
}
...
class Copier {
    ...
    async copyCatalog(obj) {
        ...
        const pages = obj.get(exports.Names.Pages, PdfDictionary);
    ...
    async pageExclusionRules(doc) {
        ...
        for (const [keyPage, value] of list) {
            for (const rule of this.rules.exclusion.rules) {
                ...
                if (record) {
                    ...
                    record[exports.Names.Page] = keyPage;
        ...
        for (const keyPage of keysBadPages) {
            ...
            const uuid = "img-1";
            page.set(exports.Names.Contents, doc.createArray(doc.createStream({
                stream: PdfBuffer.stringToRaw(doc.createImageTransformationMatrix(pageInfo, uuid))
            }).ref()));
            page.set(exports.Names.Resources, doc.createDictionary({
...
class Parser {
    constructor(doc) {
        ...
        tslib.__classPrivateFieldSet(this, _Parser_doc, doc, "f");
    }
    readXRef() {
        ...
        offset = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset);
        const xrefHeader = Parser.isWord(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset, CharWords.xref);
        if (xrefHeader.ok) {
    ...
    readObject(index, type, xref) {
        const currentXref = xref ? xref : tslib.__classPrivateFieldGet(this, _Parser_doc, "f").xref;
        const res = Parser.read(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, currentXref, index);
        if (!res.ok) {
    ...
    readHeader() {
        const pdf = Parser.findWord(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, 0, CharWords.pdf);
        if (!pdf.ok) {
            throw new Error("'%PDF-' не найден");
        }
        const version = Parser.readNumber(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, pdf.offset2 + 1);
        if (!version.ok) {
            throw new Error("Не удалось прочитать версию");
        }
        const spaces = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, version.offset2 + 1);
        const comment = Parser.readComment(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, spaces);
        const header = new Header();
        header.version = version.value.value;
        header.raw = tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer.subarray(0, comment.ok ? comment.offset2 : version.offset2);
    ...
    readIndirectObject(offset, xref) {
        const header = Parser.isObject(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset);
        if (!header.ok) {
            return new PdfNull();
        }
        return this.readObject(Parser.skipWhiteSpacesAndComments(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, header.offset2 + 1), PdfObject, xref);
    }
    static readDictionary(buffer, xref, index) {
        ...
        while (true) {
            ...
            if (end.ok) {
                ...
                if (stream.ok) {
                    const length = dictionary.get(exports.Names.Length, PdfNumber).value;
    ...
    readXRefStream(offset1) {
        const headerObj = Parser.isObject(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset1);
        if (!headerObj.ok) {
            throw new Error("XRefStream должен начинаться как IndirectObject");
        }
        const xRefStream = new XRefStream();
        xRefStream.doc = tslib.__classPrivateFieldGet(this, _Parser_doc, "f");
        try {
            tslib.__classPrivateFieldGet(this, _Parser_doc, "f").xref;
        }
        catch (error) {
            tslib.__classPrivateFieldGet(this, _Parser_doc, "f").xref = xRefStream;
        }
        xRefStream.parent = new PdfIndirectObject({ id: headerObj.pair.num1, offset: offset1, type: exports.IndirectObjectType.inUse });
        const offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, headerObj.offset2 + 1);
            ...
            for (let index = 0; index < set.num2; index++) {
                ...
                switch (field1) {
                    case 0:
                        break;
                    case 1:
                        xRefStream.push(new PdfIndirectObject({ id: objId, offset: field2, type: exports.IndirectObjectType.inUse }));
                        break;
                    case 2:
                        xRefStream.push(new PdfIndirectObject({ id: objId, objStream: field2, index: field3, type: exports.IndirectObjectType.compressed }));
                        break;
                    default:
    ...
    getLastEOF() {
        let offset1 = 0;
        let index = tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer.length;
        while (index > 0) {
            const eof = Parser.isWord(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, index--, CharWords.eof, true);
            if (eof.ok) {
                index = eof.offset1 - 1;
                break;
            }
        ...
        while (index > 0) {
            const offsetXRef = Parser.isType(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, index--, CharTypes.numbers, true);
            if (offsetXRef.ok) {
                offset1 = Parser.getNumberByOffset(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offsetXRef.offset1, offsetXRef.offset2);
    ...
    readXRefTable(offset1) {
        const start = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset1);
        const xrefHeader = Parser.isWord(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, start, CharWords.xref);
        if (!xrefHeader.ok) {
            throw new Error(`Заголовок 'xref' не найден ${offset1}`);
        }
        let offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, xrefHeader.offset2 + 1);
        const xRefTable = XRefTable.createByParams({ doc: tslib.__classPrivateFieldGet(this, _Parser_doc, "f") });
        while (true) {
            offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2);
            const tr = Parser.isWord(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharWords.trailer);
            if (tr.ok) {
                offset2 = tr.offset2 + 1;
                break;
            }
            offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2);
            const idResult = Parser.isType(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharTypes.numbers);
            if (!idResult.ok) {
                throw new Error(`Неправильный ID в заголовке таблицы XRefTable ${offset2}`);
            }
            offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, idResult.offset2 + 1);
            const countResult = Parser.isType(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharTypes.numbers);
            if (!countResult.ok) {
                throw new Error(`Неправильный Count в заголовке таблицы XRefTable ${offset2}`);
            }
            offset2 = countResult.offset2 + 1;
            const count = Parser.getNumberByOffset(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, countResult.offset1, countResult.offset2);
            const id = Parser.getNumberByOffset(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, idResult.offset1, idResult.offset2);
            for (let index = 0; index < count; index++) {
                offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2);
                const first = Parser.isType(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharTypes.numbers);
                if (!first.ok) {
                    throw new Error(`Неправильный Offset в записи таблицы XRefTable ${offset2}`);
                }
                offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, first.offset2 + 1);
                const second = Parser.isType(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharTypes.numbers);
                if (!first.ok) {
                    throw new Error(`Неправильный Generation в записи таблицы XRefTable ${offset2}`);
                }
                offset2 = Parser.skipWhiteSpaces(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, second.offset2 + 1);
                const flag = Parser.isChar(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharCodes.n);
                if (!flag) {
                    offset2 = offset2 + 2;
                    continue;
                }
                const objOffset = Parser.getNumberByOffset(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, first.offset1, first.offset2);
                if (objOffset === 0) {
                    offset2 = offset2 + 2;
                    continue;
                }
                ...
                const headerObject = Parser.isObject(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, objOffset);
                if (!headerObject) {
                ...
                const generation = Parser.getNumberByOffset(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, second.offset1, second.offset2);
        ...
        const eof = Parser.findWord(tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer, offset2, CharWords.eof);
        if (!eof.ok) {
            throw new Error("Нет окончания EOF в XRefTable");
        }
        xRefTable.raw = tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer.subarray(offset1, eof.offset2 + 1);
        return xRefTable;
    }
    ...
    getByte(offset) {
        return tslib.__classPrivateFieldGet(this, _Parser_doc, "f").buffer.raw[offset];
    }
...
class Writer {
    constructor(doc) {
        ...
        tslib.__classPrivateFieldSet(this, _Writer_doc, doc, "f");
    }
    isCorrectXRefType(typeXRef, xref) {
        if (xref instanceof XRefTable && typeXRef !== exports.XRefType.XRefTable) {
            return false;
        }
        else if (xref instanceof XRefStream && typeXRef !== exports.XRefType.XRefStream) {
            return false;
        }
        if (xref.prev) {
    ...
    save() {
        if (tslib.__classPrivateFieldGet(this, _Writer_doc, "f").xref.raw.length) {
            return tslib.__classPrivateFieldGet(this, _Writer_doc, "f").buffer.raw;
        }
        const buf = tslib.__classPrivateFieldGet(this, _Writer_doc, "f").buffer;
        if (!buf.length) {
            this.wHeader(buf);
        }
        this.wXRef(buf);
    ...
    wHeader(buf) {
        buf.append(HEADER);
        tslib.__classPrivateFieldGet(this, _Writer_doc, "f").header.raw = buf.subarray();
        buf.append(CharCodes.endLine);
    }
    wXRef(buf) {
        const targetXRefType = tslib.__classPrivateFieldGet(this, _Writer_doc, "f").xref instanceof XRefTable
            ? exports.XRefType.XRefTable
            : exports.XRefType.XRefStream;
        if (!this.isCorrectXRefType(targetXRefType, tslib.__classPrivateFieldGet(this, _Writer_doc, "f").xref)) {
            throw new Error("Документ содержит несколько типов структур");
        }
        if (tslib.__classPrivateFieldGet(this, _Writer_doc, "f").xref instanceof XRefStream) {
            this.wXRefStream(buf, tslib.__classPrivateFieldGet(this, _Writer_doc, "f").xref);
        }
        else {
            this.wXRefTable(buf, tslib.__classPrivateFieldGet(this, _Writer_doc, "f").xref);
        }
    }
    getAllObjects(xref) {
        let objects;
    ...
    removeFreeObjects(objects) {
        return new Map([...objects.entries()].filter((value) => value[1].type !== exports.IndirectObjectType.free));
    }
    ...
    wObjectStream(buf, objStream, mapObjects) {
        ...
        bufStream.end();
        objStream.set(exports.Names.Filter, parent.doc.createName(exports.Names.FlateDecode));
    ...
    wXRefStream(buf, xref) {
        ...
        buf.begin();
        const compressObj = new Map([...objects.entries()].filter((value) => value[1].type === exports.IndirectObjectType.compressed));
        if (compressObj.size) {
            this.wObjectStream(buf, ObjectStream.create(xref), compressObj);
            xref.Index.get(xref.Index.value.length - 1, PdfNumber).value++;
        }
        const inuseObj = new Map([...objects.entries()].filter((value) => value[1].type === exports.IndirectObjectType.inUse));
        ...
        buf.append(CharCodes.endLine);
        buf.end();
        tslib.__classPrivateFieldGet(this, _Writer_doc, "f").buffer = buf;
    ...
    createLineTable(obj) {
        ...
        line.append([
            ...
            obj.type === exports.IndirectObjectType.free ? CharCodes.f : CharCodes.n,
        ], CharCodes.space);
        return line.end().raw;
    }
    writeObject(buf, obj) {
...
class Document {
    ...
    get xref() {
        if (tslib.__classPrivateFieldGet(this, _Document_xref, "f")) {
            return tslib.__classPrivateFieldGet(this, _Document_xref, "f");
        }
        throw new Error("Документ не содержит xref");
    }
    set xref(v) {
        tslib.__classPrivateFieldSet(this, _Document_xref, v, "f");
    }
    read(file) {
    ...
    static create(xrefType = exports.XRefType.XRefStream) {
        const doc = new Document();
        const xref = xrefType === exports.XRefType.XRefTable ? new XRefTable() : new XRefStream();
        doc.xref = xref;
        xref.doc = doc;
    ...
    addFont(fontData, name) {
        ...
        const fontDescriptorRef = this.createDictionary({
            Type: this.createName(exports.Names.FontDescriptor),
        ...
        if (font.font.cff) {
            fontDescriptorRef.set(exports.Names.FontFile3, fontStreamRef);
        }
        else {
            fontDescriptorRef.set(exports.Names.FontFile2, fontStreamRef);
        }
        ...
        const cidFontDictRef = this.createDictionary({
            Type: this.createName(exports.Names.Font),
            Subtype: this.createName(font.font.cff ? exports.Names.CIDFontType0 : exports.Names.CIDFontType2),
            CIDToGIDMap: this.createName(exports.Names.Identity),
            BaseFont: this.createName(name),
            CIDSystemInfo: this.createDictionary({
                Registry: this.createLiteral(exports.Names.Adobe),
                Ordering: this.createLiteral(exports.Names.Identity),
        ...
        const dictionary = this.createDictionary({
            Type: this.createName(exports.Names.Font),
            Subtype: this.createName(exports.Names.Type0),
            BaseFont: this.createName(name),
            Encoding: this.createName(exports.Names.IdentityH),
...
`;
    ...
    findPagesList() {
        ...
        tslib.__classPrivateFieldSet(this, _Document_pagesList, mapPages, "f");
        return tslib.__classPrivateFieldGet(this, _Document_pagesList, "f");
    }
    findPageDict(dict) {
        const type = dict.get(exports.Names.Type, PdfName);
        switch (type.value) {
            case exports.Names.Pages:
                {
                    const kids = dict.get(exports.Names.Kids, PdfArray);
                    if (!kids.length) {
                        return [];
                    }
                    let pages = [];
    ...
    findPage(numPage) {
        var _a;
        const page = tslib.__classPrivateFieldGet(this, _Document_pagesList, "f").get(numPage);
        if (page) {
            return page;
        }
    ...
    createImage(imageBuf) {
        ...
        res.set(exports.Names.ColorSpace, this.createName(imageInfo.info.colorSpace));
        res.set(exports.Names.BitsPerComponent, this.createNumber(imageInfo.info.bitsPerComponent));
        switch (imageInfo.type) {
            case exports.ImageTypes.JPEG:
                res.value = imageBuf;
                res.set(exports.Names.Filter, this.createName(exports.Names.DCTDecode));
                break;
            case exports.ImageTypes.PNG:
                ...
                if (imageInfo.info.alphaChannel) {
                    ...
                    sMask.set(exports.Names.ColorSpace, this.createName(exports.Names.DeviceGray));
                    sMask.set(exports.Names.BitsPerComponent, this.createNumber(8));
...
Registry.set(exports.RegistryTypes.ObjectStream, ObjectStream);
Registry.set(exports.RegistryTypes.PdfView, PdfView);
Registry.set(exports.RegistryTypes.Parser, Parser);
Registry.set(exports.RegistryTypes.Writer, Writer);
Registry.set(exports.RegistryTypes.Copier, Copier);
Registry.set(exports.RegistryTypes.PdfIndirectObject, PdfIndirectObject);
Registry.set(exports.RegistryTypes.PdfDictionary, PdfDictionary);
Registry.set(exports.RegistryTypes.PdfArray, PdfArray);

exports.ASCII85Decode = ASCII85Decode;
exports.ASCIIHexDecode = ASCIIHexDecode;
exports.CIDFontWidthsConverter = CIDFontWidthsConverter;
exports.Catalog = Catalog;
exports.CharCodes = CharCodes;
exports.CharOperators = CharOperators;
exports.CharTypes = CharTypes;
exports.CharWords = CharWords;
...
exports.XRefStream = XRefStream;
exports.XRefTable = XRefTable;
exports.decodeString = decodeString;
exports.ensure1ByteHex = ensure1ByteHex;
exports.escapeSpecialSymbols = escapeSpecialSymbols;
exports.formatHex = formatHex;
exports.fromBase64 = fromBase64;
exports.fromBinary = fromBinary;
exports.generateUUID = generateUUID;
exports.generateUniqueID = generateUniqueID;
exports.hasMoreThan1ByteChars = hasMoreThan1ByteChars;
exports.hasUtf16BeBOM = hasUtf16BeBOM;
exports.hasUtf8BOM = hasUtf8BOM;
exports.hexTo2ByteHex = hexTo2ByteHex;
exports.hexToBinary = hexToBinary;
exports.isEqualRaw = isEqualRaw;
exports.toBase64 = toBase64;
exports.toBinary = toBinary;
exports.toUtf16Be = toUtf16Be;
exports.unescapeSpecialSymbols = unescapeSpecialSymbols;
