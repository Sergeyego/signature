...
class PdfSigFlags extends pdf.PdfFlags {
    constructor(options) {
        super(exports.SigFlags, options);
    }
}
exports.SigFlags = void 0;
(function (SigFlags) {
    SigFlags[SigFlags["SignaturesExist"] = 1] = "SignaturesExist";
    SigFlags[SigFlags["AppendOnly"] = 2] = "AppendOnly";
})(exports.SigFlags || (exports.SigFlags = {}));
...
class Sign {
    ...
    findSignaturesInDocument() {
        ...
        for (let index = 0; index < fields.length; index++) {
            ...
            tslib.__classPrivateFieldGet(this, _Sign_signatures, "f").set(name, new Signature(dict, name));
        }
    }
    getSignaturesList() {
        return tslib.__classPrivateFieldGet(this, _Sign_signatures, "f");
    }
    findSignature(key) {
        var _a, _b;
        if (typeof key === "string") {
            return (_a = tslib.__classPrivateFieldGet(this, _Sign_signatures, "f").get(key)) !== null && _a !== void 0 ? _a : null;
        }
        const keys = Array.from(tslib.__classPrivateFieldGet(this, _Sign_signatures, "f").keys());
        return (_b = tslib.__classPrivateFieldGet(this, _Sign_signatures, "f").get(keys[key])) !== null && _b !== void 0 ? _b : null;
    }
    getSignature(key) {
    ...
    addSignatures(...params) {
        ...
        for (const param of params) {
            ...
            if (tslib.__classPrivateFieldGet(this, _Sign_signatures, "f").has(param.name)) {
            ...
            tslib.__classPrivateFieldGet(this, _Sign_signatures, "f").set(param.name, sig);
...
exports.PdfSigFlags = PdfSigFlags;
exports.Sign = Sign;
